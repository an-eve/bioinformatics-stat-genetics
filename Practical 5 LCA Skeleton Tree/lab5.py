...
lineages = {}
# Print the full lineage for each read ID
...
# LCAs for each read
LCAs = {}
# for each sequence : iterate on the shortest list of ancestors and find all the common ancestors
...
for read_id, seq in lineages.items():
    ...
    # Step 2: Construct a directed graph (DAG)
    G = nx.DiGraph()
